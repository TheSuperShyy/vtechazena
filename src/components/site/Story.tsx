...
// quote, followed by the founder's first-person word ("דבר המייסד") beside his
// portrait.
      ...
      <div className="story__founder">
        <figure className="story__portrait">
          <img
            ...
            alt="אחיטוב ששון ממן, מייסד ותחזינה, יושב מתחת ליצירת קיר חצובה"
            loading="lazy"
            decoding="async"
            width={1000}
            height={1523}
        ...
        <div className="story__founder-text">
